            ...
            <div className={`max-w-sm py-2 px-2 gap-2 break-words rounded-sm shadow overflow-x-hidden 
                ...
                {message.isDeleted ? (<p className="italic text-gray-400">This message was deleted</p>) : (
                    <>
                        {/*reply message ui*/}
                        {message.replyTo && (
                            <div className="mb-2 border-l-4 border-green-400 bg-black/20 rounded p-2">
                        ...
                        {message.messageType === "video" && (
                            <video controls className="max-w-[220px] rounded-xl"><source src={message.video} /></video>
                        )}
                        {message.messageType === "audio" && (
                            <audio controls><source src={message.audio} /></audio>
                        )}
